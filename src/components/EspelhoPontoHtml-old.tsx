...
export function EspelhoPontoHtml(props: EspelhoPontoHtmlProps) {
    const { data, total, dataUser, origem } = props
                ...
                <div style={{
                    ...
                    {total && (
                        <div style={{
                            ...
                            {/* Totais calculados - assumindo que 'total' já contém valores formatados ou numéricos */}
                            ...
                            <div style={tableCellStyle}>
                                {formatTimeValue(total.horasAlmoco)} {/* Ou horasExtras se for diferente */}
                            </div>
                            <div style={tableCellStyle}>
                                {formatTimeValue(total.horasTrabalhadas)}
                            </div>
                            <div style={tableCellStyle}>
                                {/* Escolha uma das funções abaixo, dependendo da sua lógica */}
