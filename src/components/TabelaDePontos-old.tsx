                    ...
                    <tbody className="divide-y divide-gray-200">
                        {dados.map((item, index) => (
                            <tr key={index} className="hover:bg-gray-50 transition-colors">
                                <td className="px-4 py-3 border-x border-gray-200 text-center text-sm font-medium text-gray-900">{item.diaDoMes}</td>
                                <td className="px-4 py-3 border-x border-gray-200 text-center text-sm text-gray-700 font-bold">{item.primeiraEntrada || '—'}</td>
                                <td className="px-4 py-3 border-x border-gray-200 text-center text-sm text-gray-700 font-bold">{item.primeiraSaida || '—'}</td>
                                <td className="px-4 py-3 border-x border-gray-200 text-center text-sm text-gray-700 font-bold">{item.segundaEntrada || '—'}</td>
                                <td className="px-4 py-3 border-x border-gray-200 text-center text-sm text-gray-700 font-bold">{item.segundaSaida || '—'}</td>
                                ...
                                <td className={`px-4 py-3 text-center border-x border-gray-200 text-sm ${Number(item.debito ?? 0) > 0 ? "font-bold text-gray-700" : "text-gray-400"}`}>
                                    ...
                                    {Number(item.debito ?? 0) > 0 && item.status !== "Sem Registro" ? formatarHora(String(item.debito)) : ''}
                                </td>

                                {/* Horas Normais */}
                                <td className="px-4 py-3 text-center border-x border-gray-200 text-sm font-bold text-gray-700">
                                    {Number(item.horasNormais ?? 0) > 0 ? formatarHora(String(item.horasNormais)) : ''}
                                </td>

                                {/* Horas Almoço */}
                                <td className={`px-4 py-3 text-center border-x border-gray-200 text-sm ${Number(item.horasAlmoco ?? 0) > 0 ? "font-bold text-gray-700" : "text-gray-400"}`}>
